...
var PreventUnsavedChanges = /** @class */ (function () {
    ...
    PreventUnsavedChanges.prototype.canDeactivate = function (component) {
        if (component.editForm.dirty) {
            return confirm('are you sure you want to continue? Any unsaved changes will bi lost');
        }
        return true;
    };
...
var ListsResolver = /** @class */ (function () {
    ...
    ListsResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUsers(this.pageNumber, this.pageSize, this.userParams, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
...
var MemberListResolver = /** @class */ (function () {
    ...
    MemberListResolver.prototype.resolve = function (route) {
        ...
        this.userParams.minAge = 18;
        this.userParams.maxAge = 99;
        return this.userService.getUsers(this.pageNumber, this.pageSize, this.userParams).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            _this.alertify.error(error);
            _this.router.navigate(['/home']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
...
var AuthService = /** @class */ (function () {
    function AuthService(http) {
        ...
        this.jwHelper = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_4__["JwtHelperService"]();
    ...
    AuthService.prototype.login = function (model) {
        ...
        return this.http.post(this.baseUrl + 'login', model)
            ...
            if (user) {
                ...
                _this.decodedToken = _this.jwHelper.decodeToken(user.token);
...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService) {
        this.authService = authService;
        this.jwHelper = new _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_2__["JwtHelperService"]();
    }
...
/* harmony import */ var _value_value_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./value/value.component */ "./src/app/value/value.component.ts");
...
/* harmony import */ var _guards_prevent_unsaved_changes__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./_guards/prevent-unsaved-changes */ "./src/app/_guards/prevent-unsaved-changes.ts");
/* harmony import */ var _members_photo_edit_photo_edit_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./members/photo-edit/photo-edit.component */ "./src/app/members/photo-edit/photo-edit.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _value_value_component__WEBPACK_IMPORTED_MODULE_22__["ValueComponent"],
                ...
                _members_photo_edit_photo_edit_component__WEBPACK_IMPORTED_MODULE_30__["PhotoEditComponent"],
            ...
            providers: [
                ...
                _guards_prevent_unsaved_changes__WEBPACK_IMPORTED_MODULE_29__["PreventUnsavedChanges"],
                _resolvers_list_resolver__WEBPACK_IMPORTED_MODULE_32__["ListsResolver"],
...
module.exports = "<div class=\"container mt-5\">\n  <div *ngIf=\"!registerMode\" style=\"text-align: center\">\n    <h1>Find your match</h1>\n    <p class=\"lead\">\n      Come on in to view your matches... all you need to do is signed\n    </p>\n    <div class=\"text-center\">\n      <button class=\"btn btn-primary btn-lg\" (click)=\"registerToogle()\" >Register</button>\n      <button class=\"btn btn-info btn-lg\">Learn More</button>\n    </div>\n  </div>\n<div *ngIf=\"registerMode\" class=\"container\">\n  <div class=\"row justify-content-center\">\n      <div class=\"col4\">\n        <app-register (cancelRegister)=\"cancelRegisterMode($event)\" ></app-register>\n      </div>\n  </div>\n</div>\n\n</div>\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.registerToogle = function () {
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.senLike = function (id) {
        var _this = this;
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    MemberDetailComponent.prototype.selectedTab = function (tabId) {
...
var MemberEditComponent = /** @class */ (function () {
    ...
    MemberEditComponent.prototype.unloadedNotification = function ($event) {
    ...
    ], MemberEditComponent.prototype, "photoUrl", void 0);
...
var MemberListComponent = /** @class */ (function () {
    function MemberListComponent(userService, alertify, http, route) {
        this.userService = userService;
        this.alertify = alertify;
        this.http = http;
        this.route = route;
    ...
    MemberListComponent.prototype.getValues = function () {
        var _this = this;
    ...
    MemberListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_2__["AlertifyService"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])
    ], MemberListComponent);
...
module.exports = "card {\r\n    border: none;\r\n}\r\n\r\n.chat {\r\n    list-style: none;\r\n    margin: 0;\r\n    padding: 0;\r\n}\r\n\r\n.chat li {\r\n    margin-bottom: 10px;\r\n    padding-bottom: 10px;\r\n    border-bottom: 1 px dotted gainsboro;    \r\n}\r\n\r\n.rounded-circle {\r\n    height: 50px;\r\n    width: 50px;\r\n}\r\n\r\n.card-body {\r\n    overflow-y: scroll;\r\n}"
...
/***/ "./src/app/members/photo-edit/photo-edit.component.css":
/*!*************************************************************!*\
  !*** ./src/app/members/photo-edit/photo-edit.component.css ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./src/app/members/photo-edit/photo-edit.component.html":
/*!**************************************************************!*\
  !*** ./src/app/members/photo-edit/photo-edit.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./src/app/members/photo-edit/photo-edit.component.ts":
/*!************************************************************!*\
  !*** ./src/app/members/photo-edit/photo-edit.component.ts ***!
  \************************************************************/
/*! exports provided: PhotoEditComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PhotoEditComponent", function() { return PhotoEditComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var PhotoEditComponent = /** @class */ (function () {
    function PhotoEditComponent(authService, userService, alertify) {
        this.authService = authService;
        this.userService = userService;
        this.alertify = alertify;
        this.getMembersPhotoChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    PhotoEditComponent.prototype.fileOverBase = function (e) {
        this.hasBaseDropZoneOver = e;
    };
    PhotoEditComponent.prototype.initializerUploader = function () {
        var _this = this;
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_1__["FileUploader"]({
            ...
            headers: [{ name: 'Access-Control-Allow-Credentials', value: '*' }]
        });
        this.uploader.onAfterAddingFile = function (file) { file.withCredentials = false; };
        this.uploader.onSuccessItem = function (item, response, status, headers) {
            console.log('On succes Item method');
            if (response) {
    ...
    PhotoEditComponent.prototype.setMainPhoto = function (photo) {
        var _this = this;
    ...
    PhotoEditComponent.prototype.deletePhoto = function (id) {
        var _this = this;
        this.alertify.confirm('Are you shure to delete this photo', function () {
            _this.userService.deletePhoto(_this.authService.decodedToken.nameid, id).subscribe(function () {
                ...
                _this.alertify.success('Photo has been deleting');
            }, function (error) {
                _this.alertify.error(error);
            });
        });
    ...
    ], PhotoEditComponent.prototype, "photos", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], PhotoEditComponent.prototype, "getMembersPhotoChange", void 0);
    PhotoEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-photo-edit',
            template: __webpack_require__(/*! ./photo-edit.component.html */ "./src/app/members/photo-edit/photo-edit.component.html"),
            styles: [__webpack_require__(/*! ./photo-edit.component.css */ "./src/app/members/photo-edit/photo-edit.component.css")]
        }),
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        var _this = this;
        this.alertify.confirm('Are you sure you whant to delete this message', function () {
...
var appRoutes = [
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'member/edit', component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_8__["MemberEditComponent"], canDeactivate: [_guards_prevent_unsaved_changes__WEBPACK_IMPORTED_MODULE_10__["PreventUnsavedChanges"]],
            ...
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_3__["ListsComponent"],
                resolve: { users: _resolvers_list_resolver__WEBPACK_IMPORTED_MODULE_11__["ListsResolver"] } }
        ]
    },
...
module.exports = __webpack_require__(/*! C:\Users\mabotero\source\repos\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
